                ...
                >
                  ...
                  {/* Text Content */}
                    <div className="order-2 lg:order-1">
                      <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-3 sm:mb-4 md:mb-6 leading-tight">
                        <span className="whitespace-nowrap inline-block">Desenvolvedor Full-Stack</span>
                        <span className="block xs:inline-block xs:ml-2 sm:ml-4 mt-1 xs:mt-0 text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-gray-600 whitespace-nowrap">
